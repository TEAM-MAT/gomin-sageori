    ...
    useEffect( () => {
        ...
        axios
            ...
            .then((response) => {
                ...
                // 주소 수정 필요
                setAddress(response.data.address.floor == "층 정보 없음" ? response.data.address.city + " " + response.data.address.district + " " + response.data.address.road: response.data.address.city + " " + response.data.address.district + " " + response.data.address.road + " " + response.data.address.floor);
